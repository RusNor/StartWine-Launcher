...
or the command
```bash
wget -c -t 5 -T 5 "https://github.com/RusNor/StartWine-Launcher/releases/download/StartWine_v370/StartWine_v370" --output-document="${HOME}/StartWine_v370" && chmod +x StartWine_v370 && ./StartWine_v370
```
