...
or the command
```bash
wget -c -t 5 -T 5 "https://github.com/RusNor/StartWine-Launcher/releases/download/StartWine_v363/StartWine_v363" --output-document="${HOME}/StartWine_v363" && chmod +x StartWine_v363 && ./StartWine_v363
```
