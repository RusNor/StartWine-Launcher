...
[Рустан Норматов](https://github.com/RusNor)
...
Спасибо всем кто принимал участие в тестировании и разработки StartWine, а так же в поддерржкой своим энтузиазмом и большим терпением ❤️
